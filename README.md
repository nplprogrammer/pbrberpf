...
This plugin is an attempt to provide pre-filtered searches for those cenarios where search results need to exclude some arbitray set of inventory, dependent on some "conversion path."
